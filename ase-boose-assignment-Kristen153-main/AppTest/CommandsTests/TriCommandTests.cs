...
{
    /// <summary>
    /// Contains unit tests for the <see cref="TriCommand"/> class.
    /// </summary>
    [TestClass]
    public sealed class TriCommandTests
    {
        /// <summary>
        /// Mock implementation of the <see cref="Canvas"/> class for testing purposes inside <see cref="TriCommandTests"/>.
        /// </summary>
        private class MockCanvas : Canvas
        {
            public int LastWidth { get; private set; }
            public int LastHeight { get; private set; }
            public bool TriCalled { get; private set; }

            /// <summary>
            /// Overrides the <see cref="Canvas.Tri(int, int)"/> method to capture test data.
            /// </summary>
