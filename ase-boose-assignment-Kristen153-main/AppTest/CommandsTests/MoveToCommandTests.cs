...
{
    /// <summary>
    /// Contains unit tests for the <see cref="MoveToCommand"/> class.
    /// </summary>
    [TestClass]
    public sealed class MoveToCommandTests
    {
        private class MockCanvas : Canvas
        {
            /// <summary>
            /// Mock implementation of the <see cref="Canvas"/> class for testing purposes inside <see cref="MoveToCommandTests"/>.
            /// </summary>
            ...
            /// <summary>
            /// Overrides the <see cref="Canvas.MoveTo(int, int)"/> method to capture the input coordinates.
            /// </summary>
            /// <param name="x">The X-coordinate of the move endpoint.</param>
            /// <param name="y">The Y-coordinate of the move endpoint.</param>
        ...
        {
            MockCanvas mock = new();
            MoveToCommand cmd = new(mock, 4, 6);
            Assert.IsNotNull(cmd);
